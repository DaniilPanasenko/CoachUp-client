...
import $ from 'jquery'
import {addTraining} from '../../actions/course'
...
class AddForm extends React.Component{
  ...
  handleClick =()=>{
    if(this.state.name!='' && this.state.description!=''){
      this.props.addTraining({name:this.state.name, description:this.state.description}, this.props.course.courseInfo.id);
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="staticBackdropLabel"><Trans>Add training</Trans></h5>
